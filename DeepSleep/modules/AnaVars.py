...
class AnaVars:
    ...
    def __init__(self, year, isData, jec_sys=None, jec_type=None):
        ...
        self.jec_dict = {
            ...
            f'jesHF{self.ud}'            :f'_jesHF_{self.year}{self.ud}',
            f'jesAbsolute{self.ud}'      :f'_jesAbsolute_{self.year}{self.ud}',
            f'jesEC2{self.ud}'           :f'_jesEC2_{self.year}{self.ud}',
            f'jesBBEC1{self.ud}'         :f'_jesBBEC1_{self.year}{self.ud}',
