...
def initDF():
    ...
    #
    # organize by process
    cuts = (lambda df_: df_[(df_['NN'] > 0.95) & (df_['Zh_pt'] > 300)])
    df = cuts(df)
    ordered_p = ['ttZ','ttH','tt_bb','tt_2b','TTBar','rare']
    ...
    ax.set_xlabel('Z/H $m_{sd}$ ($NN > 0.95$; Z/H $p_{t}>300$) (GeV)', fontsize = 12)
    ...
    plt.savefig('pdf/zhm_95nn_300pt_run2.pdf')
