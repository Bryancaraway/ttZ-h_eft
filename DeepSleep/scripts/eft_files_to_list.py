...
#eft_dir = '/cms/data/store/user/bcaraway/NanoAODv7/PostProcessed/2017/TTbb_EFT_2017/*prod2017MC_v7_NANO_*.root'
#out_name = 'tt_B_eft_2017.txt'
#eft_dir = '/cms/data/store/user/bcaraway/NanoAODv7/PostProcessed/2016/TTbb_EFT_2016/prod2016MC_v7_NANO_*.root'
#out_name = 'tt_B_eft_2016.txt'
#
